...
export default function Topbar() {
	...
	return (
		<div className="fixed top-0 pt-[36px] left-[306px] px-[32px] lg:px-[88px] right-0 flex items-center justify-between">
			<h1>Hello Evano 👋🏼,</h1>
			<div
				className={`h-10 bg-white rounded-[12px] w-full max-w-[216px] flex items-center gap-2 px-4 ${
