...
export default function Login() {
	...
	return (
		<main className="bg-background-two grid place-items-center h-screen">
			<section className="flex flex-col max-w-[502px] w-full bg-background-one rounded-[24px] px-[44px] pt-8 pb-10">
				...
				<form onSubmit={handleSubmit(onSubmit)}>
					...
					<div className=" mb-[20px]">
						<div
							className={`h-[56px] p-4 rounded-[12px] border flex items-center w-full ${
								input === "name" ? "border border-primary" : "border-stroke"
							} `}
						>
					...
					<div className=" mb-[20px]">
						<div className="flex gap-4">
							...
							<div
								className={`h-[56px] p-4 rounded-[12px] border flex items-center w-full ${
									input === "phoneNumber" ? "border-[2px] border-primary" : "border-stroke"
								} `}
							>
								<fieldset className="flex flex-col w-full">
